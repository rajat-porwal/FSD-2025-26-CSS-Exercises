...
These exercises consist of a series of CSS-related tasks intended to complement the HTML and CSS study material. They should only be completed when instructed during the course of the curriculum.

When doing these exercises, please use all documentation and resources you need to accomplish them. You are _not_ intended to have any of this stuff memorized at this point. Check the FSD Notes, use Google, and do what you need to do (besides checking the solutions) to get them done.
...
1. Once you successfully finish an exercise, check solution to compare it with yours.
    - You should not be checking the solution for an exercise until you finish it!
    - If your solution differs wildly from solution (and still passes the exercise's requirements), that's completely fine. Do feel free to ask about it in whatsapp chat if there are parts you do not understand.
